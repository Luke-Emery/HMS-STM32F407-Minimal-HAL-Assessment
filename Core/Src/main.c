/**
  ...
  * to correctly pass data for any application.
  *
  * ✨THIS TEMPLATE SHOULD BE POPULATED BEFORE SUBMITTING ASSESSED WORK ✨
  *
  ******************************************************************************
  * @attention
  *
  ...
  *
  * Hardware, Microcontrollers and Sensors (COMP50069)
  *
  ******************************************************************************
  */
...
/**
  ...
  *
  * Peripherals should be after system clocks.
  */
int main(void)
{
	/* Local Variables */
...
/**
  ...
  * @retval None
  *
  * Configure clocks, LSE is not populated
  * on this board therefore LSI used for RTC
  *
  * Disabled LSI to use HSE, see MSP.
  */
...
/**
  ...
  * @retval None
  *
  * Skeleton Error_Handler provided by vendor (ST Microelectronics)
  */
